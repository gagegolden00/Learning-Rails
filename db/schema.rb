...
ActiveRecord::Schema[7.0].define(version: 2023_09_22_234601) do
  ...
  create_table "active_record_questions", force: :cascade do |t|
  ...
  add_foreign_key "active_record_answers", "active_record_questions"
end
